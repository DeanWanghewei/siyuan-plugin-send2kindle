# SiYuan Send to Kindle / 发送到 Kindle

将思源笔记文档一键转换为 EPUB，并通过 Amazon **Send-to-Kindle** 邮件通道发送到你的 Kindle 设备。

Send any SiYuan document to your Kindle as a converted EPUB via the Send-to-Kindle email channel.
